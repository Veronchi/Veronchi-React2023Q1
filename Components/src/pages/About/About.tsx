    ...
    return (
      <section className="about">
        ...
        <p className="about__text">
          ...
          looking for the next big thing our customers will love. Founded in Vienna in 2019, we are
          proud to be your Online Clothing Shop that you can rely on for our expert service and
          care.
        </p>
        <p className="about__text">
          ...
          goal is to help our customers by providing them with unique outfit and accessories that
